...
- **Formatting:** Use proper Markdown structure. Technical lists must be bulleted or numbered. Use headers for sub-sections. Do not skip header levels. Avoid "walls of text" by using double newlines between paragraphs.
